...
const ContactForm = () => {
    ...
    return (
        <div ref={rootRef}>
            <Card data-form-card className="w-full bg-gray-50 rounded-xl px-2 py-4 lg:p-10">
                <CardHeader>
                        ...
                        <FieldGroup>
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid}>
                                            <Input
                                                ...
                                                placeholder="الاسم"
                                                autoComplete="off"
                                                className="border-0 border-b-2 border-gray-200 bg-white h-12 "
                                            />
                            ...
                            <div data-form-field>
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid}>
                                            <InputGroup className="border-0 border-b-2 border-gray-200 bg-white">
                                                <InputGroupTextarea
                                                    {...field}
